...
export const japanModels: Record<string, number> = {
  ...
  nice: require('../../../../../assets/models/Nice_France.glb'),
  'tokyo-tower': require('../../../../../assets/models/Tokyo_Japan .glb'),
  kyoto: require('../../../../../assets/models/Kyoto_Japan.glb'),
  osaka: require('../../../../../assets/models/Osaka_Japan .glb'),
  sapporo: require('../../../../../assets/models/Sappora_Japan.glb'),
  shizuoka: require('../../../../../assets/models/Shizuoka_Japan.glb'),
};
